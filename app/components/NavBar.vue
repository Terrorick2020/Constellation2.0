    ...
    <div class="sticky top-5 w-full">
      ...
      <div class="pt-10">
        <NavigationLink
          ...
          :key="link.id"
          :link="link"
          class="border-b border-black/10 py-5 first:pt-0 last:border-0"
        />
      </div>
    </div>
  </aside>
...
const adsRoute = clientRoutes.account.local.ads
...
const toAds = `${globAccountRoute}${adsRoute}`
...
const navigationLinks = [
  ...
  { id: 2, title: 'Обьявления', path: toAds, iconName: 'fire' },
