  ...
  <section class="relative w-full rounded-3xl border border-transparent font-medium">
    <div class="absolute left-0 right-0 top-0 z-[1] w-full">
      ...
      <div
        ...
        :style="`background-image: url(${Image}); background-color: rgb(10, 39, 81);`"
    ...
    >
      ...
      <h2 class="custom-h2" hidden><big class="text-700">Пользователь:</big> {{ persone.id }}</h2>
